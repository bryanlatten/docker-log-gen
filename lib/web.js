...
app.get('/', function(req, res) {
  var options = _.cloneDeep(app.get('options'));
  ...
  options.multiline = !!parseInt(options.multiline);
  ...
  res.send(new Date() + ' - Logged ' + options.number + ' lines, ' + bytes + ' bytes,' + ' in ' + (end - start) + 'ms to stdout');
})
